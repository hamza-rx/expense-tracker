        ...
        <div className="relative bg-violet-600 overflow-hidden shrink-0 md:w-[42%]
          ...
          <div className="relative z-10 flex items-center gap-2.5 md:hidden">
            ...
            <div>
              ...
              <p className="text-violet-200 text-[10px] mt-0.5">Create your account</p>
            </div>
          </div>
          <Link href="/login"
        ...
        <div className="flex-1 bg-white dark:bg-zinc-800 flex flex-col items-center md:justify-center
          ...
          <div className="w-full max-w-sm">
            ...
            <div className="text-center mb-6">
              <h1 className="text-2xl sm:text-3xl font-black text-zinc-800 dark:text-white tracking-tight">create account</h1>
            ...
            <form onSubmit={handleSubmit} className="space-y-3">
              ...
              <div className="relative">
                <input name="password" type={showPassword ? "text" : "password"} required autoComplete="new-password" placeholder="Password..."
            ...
            <div className="relative my-4">
              ...
              <div className="relative flex justify-center">
                <span className="bg-white dark:bg-zinc-800 px-3 text-[10px] font-bold text-zinc-400 uppercase tracking-widest">or sign up with</span>
              </div>
            </div>
